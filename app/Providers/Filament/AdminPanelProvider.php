...
class AdminPanelProvider extends PanelProvider
{
    public function boot(): void
    {
        FilamentView::registerRenderHook(
            ...
            fn (): string => view('filament.admin.custom-styles')->render()
        );
    }
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->darkMode(true)
            ->brandLogo(asset('assets/images/resources/vck-logo.webp'))
            ->darkModeBrandLogo(asset('assets/images/resources/vck-logo.webp'))
