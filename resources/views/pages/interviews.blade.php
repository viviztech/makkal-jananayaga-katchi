                    ...
                    <div class="overflow-hidden flex flex-col h-full">
                        ...
                        <div class="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-700">
                            ...
                            <div class="absolute top-2 right-2">
                                <div class="bg-white text-[var(--color-mjk-orange)] px-2 py-1 rounded-md text-xs font-semibold shadow-md">
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            ...
                            <h3 class="text-base font-semibold text-gray-900 mb-2 line-clamp-2 leading-tight min-h-[2.5rem]">
                                 <a href="{{ route('media.show', $interview->slug) }}" class="hover:text-[var(--color-mjk-orange)] transition-colors duration-200">
                            ...
                            <div class="flex items-center justify-between text-xs text-gray-500 mt-auto pt-3 border-t border-gray-200">
                                ...
                                <span class="bg-[var(--color-mjk-orange)]/10 text-[var(--color-mjk-orange)] px-2 py-0.5 rounded-full text-xs font-medium">
                             ...
                             {{-- Action Button --}}
                            <div class="mt-3">
                                <a href="{{ route('media.show', $interview->slug) }}" class="block text-center bg-[var(--color-mjk-orange)] hover:bg-orange-700 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors duration-200">
            ...
            <div class="text-center py-24" data-aos="fade-up">
                <div class="max-w-lg mx-auto">
                    <div class="bg-gray-100 p-12 rounded-3xl">
                        ...
                        <h2 class="text-3xl font-extrabold text-gray-900 mb-4">{{ __('site.interviews.no_interviews') }}</h2>
