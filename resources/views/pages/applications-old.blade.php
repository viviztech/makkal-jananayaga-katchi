...
@section('content')
    ...
    <section class="relative bg-gray-900 dark:bg-gray-950 py-24 md:py-32">
        <div class="relative max-w-7xl mx-auto px-4 text-center">
            <h1 class="text-5xl md:text-6xl font-extrabold text-white mb-4">{{ __('site.applications.title') }}</h1>
            <p class="text-xl text-gray-300 max-w-3xl mx-auto">{{ __('site.applications.subtitle') }}</p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8 lg:p-12">
                <div class="text-center mb-10">
                    <h2 class="text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white mb-3">{{ __('site.applications.form_title') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('site.applications.form_description') }}</p>
                </div>
                ...
                <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10" id="applicationForm">
                    ...
                    {{-- Timestamp for form submission validation --}}
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-2 lg:col-span-3">
                                ...
                                <textarea id="address" name="address" rows="3" class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200 resize-none text-gray-900 dark:text-white dark:placeholder-gray-400" placeholder="{{ __('site.applications.address') }}">{{ old('address') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <button type="button" id="verifyMobileBtn" class="mt-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
...
{{-- Location Information Section --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Client-side form validation and security
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Validate name format (no numbers or special characters except space and dot)
