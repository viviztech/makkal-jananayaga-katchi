                    ...
                    <div class="overflow-hidden flex flex-col h-full">
                        ...
                        <div class="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-700">
                            <a href="{{ route('media.show', $event->slug) }}" class="block w-full h-full">
                                <img src="{{ $event->featured_image_url }}" alt="{{ app()->getLocale() === 'ta' ? $event->title_ta : $event->title_en }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            </a>
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            ...
                            <h3 class="text-base font-semibold text-gray-900 mb-2 line-clamp-2 leading-tight min-h-[2.5rem]">
                                 <a href="{{ route('media.show', $event->slug) }}" class="hover:text-[var(--color-mjk-green)] transition-colors duration-200">
                                    {!! app()->getLocale() === 'ta' ? $event->title_ta : $event->title_en !!}
                                 </a>
                            </h3>

                            {{-- Description/Excerpt --}}
                            @if(app()->getLocale() === 'ta' ? $event->content_ta : $event->content_en)
                            <p class="text-gray-600 text-xs mb-3 line-clamp-2 flex-grow leading-relaxed">
                                {!! Str::limit(strip_tags(app()->getLocale() === 'ta' ? $event->content_ta : $event->content_en), 80) !!}
                            </p>
                            @endif
                            ...
                            <div class="flex items-center justify-between text-xs text-gray-500 mt-auto pt-3 border-t border-gray-200">
                             ...
                             {{-- Action Button --}}
                            <div class="mt-3">
                                <a href="{{ route('media.show', $event->slug) }}" class="block text-center bg-[var(--color-mjk-green)] hover:bg-green-700 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors duration-200">
            ...
            <div class="text-center py-24" data-aos="fade-up">
                <div class="max-w-lg mx-auto">
                    <div class="bg-gray-100 p-12 rounded-3xl">
                        ...
                        <h2 class="text-3xl font-extrabold text-gray-900 mb-4">{{ __('site.events.no_events') }}</h2>
