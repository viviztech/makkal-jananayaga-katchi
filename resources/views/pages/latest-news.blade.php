                    ...
                    <div class="relative bg-white dark:bg-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col h-full border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-700">
                            <a href="{{ route('media.show', $news->slug) }}" class="block w-full h-full">
                                <img src="{{ $news->featured_image_url }}" alt="{{ app()->getLocale() === 'ta' ? $news->title_ta : $news->title_en }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            </a>

                            {{-- Event Date Badge --}}
                            @if($news->event_date)
                            <div class="absolute top-2 right-2">
                                <div class="bg-white dark:bg-gray-900 text-blue-700 dark:text-blue-300 px-2 py-1 rounded-md text-xs font-semibold shadow-md">
                                    {{ $news->event_date->format('M j') }}
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="p-4 flex flex-col flex-grow bg-white dark:bg-gray-800">
                            ...
                            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2 line-clamp-2 leading-tight min-h-[2.5rem]">
                                 <a href="{{ route('media.show', $news->slug) }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
                                    {!! app()->getLocale() === 'ta' ? $news->title_ta : $news->title_en !!}
                                 </a>
                            </h3>

                            {{-- Description/Excerpt (Optional) --}}
                            @if(app()->getLocale() === 'ta' ? $news->content_ta : $news->content_en)
                            <p class="text-gray-600 dark:text-gray-300 text-xs mb-3 line-clamp-2 flex-grow leading-relaxed">
                                {!! Str::limit(strip_tags(app()->getLocale() === 'ta' ? $news->content_ta : $news->content_en), 80) !!}
                            </p>
                            @endif
                            ...
                            <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mt-auto pt-3 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <span class="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full text-xs font-medium">
                            ...
                            <div class="mt-3 flex items-center gap-2">
                                <a href="{{ route('media.show', $news->slug) }}" class="flex-1 inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-md text-xs font-medium transition-colors duration-200">
                ...
                <aside class="w-full lg:w-1/4 lg:sticky lg:top-4 lg:h-fit space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            @endforeach
                            <a href="{{ route('gallery') }}" class="block text-center mt-4 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors">
                                {{ __('site.about.learn-more') }} →
                            </a>
                        </div>
                    </div>
