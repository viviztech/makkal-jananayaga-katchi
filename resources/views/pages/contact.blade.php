...
<section class="bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            {{-- Address Card --}}
            <x-impact-card
                :title="__('site.contact.visit_office')"
                :description="__('site.contact.address')"
                color="primary"
                data-aos-delay="100"
            >
                <x-slot name="icon">
            ...
            >
                ...
                <x-slot name="description">
                    <a href="tel:{{ str_replace(' ', '', __('site.contact.phone')) }}" class="text-[var(--color-mjk-blue)] hover:text-[var(--color-mjk-red)] font-semibold transition-colors">
            ...
            {{-- Email Card --}}
            <x-impact-card
                :title="__('site.contact.email_us')"
                color="success"
                data-aos-delay="300"
            >
                <x-slot name="icon">
                ...
                <x-slot name="description">
                    <a href="mailto:{{ __('site.contact.email') }}" class="text-[var(--color-mjk-green)] hover:text-[var(--color-mjk-red)] font-semibold transition-colors break-all">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <x-form-input
                                    id="email"
                                    name="email"
                                    :label="__('site.contact.email-title')"
                                    type="email"
                                    :value="old('email')"
                                    required
                                />
            ...
            <div class="lg:col-span-1">
                <div class="card-campaign sticky top-24" data-aos="fade-up" data-aos-delay="200">
                    <div class="p-8 bg-gradient-to-br from-[var(--color-mjk-red)] to-[var(--color-mjk-blue)] text-white">
                        ...
                        <div class="flex flex-wrap justify-center gap-3">
                            <a href="https://www.facebook.com/people/Viduthalai-Chiruthaigal-katchi/61578689859070/"
                               ...
                               class="w-12 h-12 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition-all transform hover:scale-110"
                               aria-label="Facebook">
                            ...
                            <a href="https://www.threads.net/@vck_officiall"
                               target="_blank"
                               rel="noopener noreferrer"
                               class="w-12 h-12 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center transition-all transform hover:scale-110"
                               aria-label="Threads">
